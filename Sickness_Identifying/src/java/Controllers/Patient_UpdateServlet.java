 ...
 * @author CHRIS MALEMA
 */
public class Patient_UpdateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     st=MY_Connector.getConnection().createStatement();
       ...
       if(request.getParameter("update")!=null)
         {
             String query="update `users` set `password`='"+password+"',`email`='"+email+"', `contacts`='"+contact+"' where `username`='"+uname+"'";
          ...
          else
          {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Admin_UpdateServ</title>");            
            out.println("</head>");
            out.println("<body>");
