<%-- 
    Document   : Patient_Cancel_App
    Created on : Jun 19, 2021, 12:33:14 AM
    Author     : CHRIS MALEMA
--%>
...
<html>
    <head>
        ...
        <title>Cancel Appointment | Sickness Identifier</title>
         <style>
...
img
{
   ...
   %>
            ...
            <center>
            <h3>Please note that by canceling your appointment with the doctor, you are deleting from the system, then you will have to book again to see the doctor</h3>
            <br>
